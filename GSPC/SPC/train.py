...
model_name="{}/spc".format(model)+'_'+str(RANDOM_SEED)+'_'+str(batch)+'_'+str(model_output)+'.bin'
file_name="{}/spc_senti".format(result)+'_'+str(RANDOM_SEED)+'_'+str(batch)+'_'+str(model_output)+'.csv'
sfile_name="{}/spc_sar".format(result)+'_'+str(RANDOM_SEED)+'_'+str(batch)+'_'+str(model_output)+'.csv'
nfile_name="{}/spc_new".format(result)+'_'+str(RANDOM_SEED)+'_'+str(batch)+'_'+str(model_output)+'.csv'
print(model_name)
print(file_name)
print(nfile_name)
...
class Model_utils(object):
    def __init__(self,UNCASED,model_output):
        self.model = SPC(UNCASED,output=model_output).to(device)
...
best_accuracy=0
early_stop=0
# for alpha in np.arange(0.001,0.03,0.001):
for i in range(0,1):
    ...
    for epoch in range(1,epochs+1):
        ...
        tower1_dev_acc,loss1 =  model_utils.validation(senti_test_loader,len(senti_test_data[0]))
    ...
    print(classification_report(label_senti,prediction_senti,digits=4))
